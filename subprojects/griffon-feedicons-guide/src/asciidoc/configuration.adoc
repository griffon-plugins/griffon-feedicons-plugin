...
----
dependencies {
    griffon '{project-group}:griffon-feedicons-plugin:{project-version}'
}
----
...
----
dependencies {
    compile '{project-group}:griffon-feedicons-swing:{project-version}'
}
----
...
----
dependencies {
    compile '{project-group}:griffon-feedicons-javafx:{project-version}'
}
----
...
----
dependencies {
    compile '{project-group}:griffon-feedicons-swing-groovy:{project-version}'
}
----
...
----
dependencies {
    compile '{project-group}:griffon-feedicons-javafx-groovy:{project-version}'
}
----

== Maven

First configure the `griffon-feedicons-plugin` BOM in your POM file, by placing the following
