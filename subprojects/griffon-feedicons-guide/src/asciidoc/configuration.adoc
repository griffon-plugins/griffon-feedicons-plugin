...
----
dependencies {
    griffon '{groupId}:griffon-feedicons-plugin:{project-version}'
}
----
...
----
dependencies {
    compile '{groupId}:griffon-feedicons-swing:{project-version}'
}
----
...
----
dependencies {
    compile '{groupId}:griffon-feedicons-javafx:{project-version}'
}
----
...
----
dependencies {
    compile '{groupId}:griffon-feedicons-swing-groovy:{project-version}'
}
----
...
----
dependencies {
    compile '{groupId}:griffon-feedicons-javafx-groovy:{project-version}'
}
----
